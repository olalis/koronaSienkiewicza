<?php
/**
 * Blossom Floral Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Floral_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Floral_Repeater_Setting extends WP_Customize_Setting {
