<?php
/**
 * Blossom Floral Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Floral_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Floral_Slider_Control extends WP_Customize_Control {

		public $type = 'blossom-floral-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-floral-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-floral-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
